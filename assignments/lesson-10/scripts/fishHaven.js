...
weatherForecast.onload = function() {
    ...
    day1weather.innerHTML = '<img src="https://openweathermap.org/img/w/' + weekday[date.getDay()] + '.png" width="100px" class="forecastImg">';
    day2weather.innerHTML = '<img src="https://openweathermap.org/img/w/' + weekday[date.getDay() + 1] + '.png" width="100px" class="forecastImg">';
    day3weather.innerHTML = '<img src="https://openweathermap.org/img/w/' + weekday[date.getDay() + 2] + '.png" width="100px" class="forecastImg">';
    day4weather.innerHTML = '<img src="https://openweathermap.org/img/w/' + weekday[date.getDay() + 3] + '.png" width="100px" class="forecastImg">';
    day5weather.innerHTML = '<img src="https://openweathermap.org/img/w/' + weekday[date.getDay() + 4] + '.png" width="100px" class="forecastImg">';
}